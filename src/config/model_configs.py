...
MODEL_CONFIGS: Dict[str, ModelConfig] = {
    ...
    "Qwen3-4B-Instruct-FP8": ModelConfig(
        ...
        hf_name="Qwen/Qwen3-4B-Instruct-2507-FP8",
        max_length=262144,
        memory_gb=5.0,
        supports_flash_attention=True,
    ),
    "GLM-4.7-Flash-FP8": ModelConfig(
        name="GLM-4.7-Flash-FP8",
        hf_name="mratsim/GLM-4.7-Flash-FP8",
        max_length=131072,
        memory_gb=30.0,
        supports_flash_attention=True,
    ),
    ...
    "Qwen3-VL-4B-Instruct-4bit": ModelConfig(
...
PRESET_MODEL_SETS = {
    ...
    "qwen3_models": ["Qwen3-0.6B", "Qwen3-4B-Instruct", "Qwen2.5-32B", "Qwen3-32B", "Qwen3-8B", "Qwen3-8B-Instruct", "Qwen3-4B-Instruct-GGUF", "Qwen3-4B-Instruct-4bit"],
    "qwen3_vl_models": ["Qwen2-VL-7B", "Qwen3-VL-4B-Instruct", "Qwen3-VL-4B-Instruct-4bit", "Qwen3-VL-4B-Instruct-FP8", "Qwen3-VL-4B-Instruct-GGUF"],
